CREATE DATABASE  IF NOT EXISTS `ssi_rest` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ssi_rest`;
-- MySQL dump 10.13  Distrib 5.6.11, for Win32 (x86)
--
-- Host: localhost    Database: ssi_rest
-- ------------------------------------------------------
...
CREATE TABLE `customer` (
  ...
  UNIQUE KEY `SQL130323125543660` (`CUSTOMER_ID`)
...
CREATE TABLE `discount_code` (
  ...
  UNIQUE KEY `SQL130323125551910` (`DISCOUNT_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `manufacturer` (
  ...
  UNIQUE KEY `SQL130323125600870` (`MANUFACTURER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `micro_market` (
  ...
  UNIQUE KEY `SQL130323125618500` (`ZIP_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  UNIQUE KEY `SQL130323125629620` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_code` (
  ...
  UNIQUE KEY `SQL130323125639230` (`PROD_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `purchase_order` (
  ...
  UNIQUE KEY `SQL130323125649590` (`ORDER_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-04 10:37:45
